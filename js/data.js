...
const profile = {
  name: "黄磊",
  avatar: "images/hl.jpg",   // 把头像图片放到 images/ 文件夹
  school: "华南理工 大学",
  major: "机械工程 · 硕士",
  research: "机械臂+视觉",
  ...
  // 教育背景
  education: [
    { period: "2025 - 至今", school: "华南理工 大学", degree: "硕士 · 机械工程" },
    { period: "2021 - 2025", school: "华南理工 大学", degree: "学士 · 机械工程" }
  ],

  // 技能标签
  skills: ["机械臂抓取控制", "视觉识别系统",  "Python", "AI工具应用", "PDMS倒模", "文献检索"],
...
const experiments = [
  {
    id: "exp-1",
    name: "Western Blot — 蛋白X表达检测",
    description: "检测不同处理条件下蛋白X在 HepG2 细胞中的表达水平变化。",
    timeline: [
      {
        date: "2026-06-11",
        title: "第三次重复 — 条件优化后结果较好",
        content: "本次将一抗稀释比调整为 1:2000，封闭液改用 5% BSA。条带清晰，背景低。三次重复结果一致性好（CV < 10%），可以用于正式数据分析。下一步：进行灰度扫描和统计分析。"
      },
      {
        date: "2026-06-01",
        title: "第二次尝试 — 曝光时间过长",
        content: "第一次结果条带信号偏弱，本次将曝光时间从 30s 延长到 2min。但背景也随之升高。决定保持曝光 1min，调整一抗浓度作为优化方向。"
      },
      {
        date: "2026-05-25",
        title: "第一次 Western Blot 实验",
        content: "完成了从蛋白提取、定量、电泳、转膜到抗体孵育和显影的全流程。步骤如下：\n1. RIPA 裂解 + PMSF 提取总蛋白\n2. BCA 法定量（标准曲线 R² = 0.998）\n3. 10% SDS-PAGE，80V 浓缩 30min + 120V 分离 90min\n4. 湿转法 300mA 90min 转 PVDF 膜\n5. 5% 脱脂牛奶封闭 1h\n6. 一抗 1:1000 4°C 过夜\n7. 二抗 1:5000 室温 1h\n8. ECL 显影，曝光 30s"
      }
    ]
  },
  {
